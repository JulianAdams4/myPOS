...
class AddForeignKeysTablesRelatedToComponentVariations extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('component_stock', function (Blueprint $table) {
            $table->foreign('component_variation_id')->references('id')->on('components')->onDelete('cascade');
        });
        ...
        Schema::table('component_variation_components', function (Blueprint $table) {
            $table->foreign('comp_var_origin_id')->references('id')->on('components')->onDelete('cascade');
            $table->foreign('comp_var_destination_id')->references('id')->on('components')->onDelete('cascade');
        });
