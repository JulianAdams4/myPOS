...
class CancelOrderTimer implements ShouldQueue
{
    use Dispatchable, InteractsWithQueue, Queueable, SerializesModels,DidiRequests;
    ...
    public function handle()
    {
        ...
        foreach ($orders as $key => $order) {
            ...
            if ($diff >= 60) {
                Log::info('Se encontro ordenes que no han sido aceptadas ni rechazadas en un tiempo mayor o igual a 60 segundos');
                    ...
                    function () use ($order_id, $store_id) {
                        ...
                        switch ($order_integration->integration_name) {
                            case AvailableMyposIntegration::NAME_EATS:
                                    ...
                                    $msg = '{ "reason": { "explanation": "Orden rechazada por la tienda." } }';
