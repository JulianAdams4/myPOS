...
class Environment {
	...
	private static $paymentsUrl = "https://xxx";

	/** url used to reports service api  */
	private static $reportsUrl = "https://xxx";

	/** url used to subscriptions service api  */
	private static $subscriptionsUrl = "https://xxx";

	/** url used to subscriptions service api  if the test variable is true */
	private static $paymentsTestUrl = "https://xxx";

	/** url used to reports service api  if the test variable is true */
	private static $reportsTestUrl = "https://xxx";

	/** url used to subscriptions service api  if the test variable is true */
	private static $subscriptionsTestUrl = "https://xxx";
